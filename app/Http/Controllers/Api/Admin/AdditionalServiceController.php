...
class AdditionalServiceController extends Controller
{
    ...
    public function __construct( ApiResponse $apiResponse, AdditionalService $additionalServiceModel )
    {
    ...
    public function index()
    {
        ...
        return $this->apiResponse->setSuccess("Additional services has been retrived successfully")->setData($this->additionalServiceModel->all())->getJsonResponse();
    ...
    public function store(Request $request)
    {
        ...
        try{
            $additionalService = $this->additionalServiceModel->create($request->all());
            return $this->apiResponse->setSuccess("Additional service has been added successfully")->setData($additionalService)->getJsonResponse();
    ...
    public function update(Request $request, AdditionalService $service)
    {
        ...
        try{
            ...
            $service->refresh();
            return $this->apiResponse->setSuccess("Additional service has been updated successfully")->setData($service)->getJsonResponse();
        }catch(Exception $exception){
            return $this->apiResponse->setError($exception->getMessage())->setData()->getJsonResponse();
        }
    }
